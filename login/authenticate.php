        ...
        if ($stmt->num_rows > 0) {
            ...
            if ($match) {
                ...
                if ($stmt) {
                    ...
                    die('Failed to prepare SQL statement for tracking last login. (ERROR: 0003)');
                ...
                if ($stmt) {
                    ...
                    if ($stmt) {
                        ...
                        // notify user that the SQL statement to authenticate credentials failed
                        die('Failed to prepare SQL statement for tracking login attempts. (ERROR: 0002)');
                    ...
                    // notify user that the SQL statement to authenticate credentials failed
                    die('Failed to prepare SQL statement for tracking login attempts. (ERROR: 0001)');
